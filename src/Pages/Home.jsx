    ...
    return (
        <div>
            ...
            <div className="bg-[#e9e9e9] py-3 md:py-10 px-2 md:px-0">
                ...
                {/*    <h1>{content.name}</h1>*/}
                {/*</div>*/}
                <div className="container mx-auto bg-white rounded-3xl px-4 py-5 md:px-10 md:py-8 custom-font ck-content" dangerouslySetInnerHTML={{ __html: content.content }}></div>
            </div>
        </div>
    )
}
