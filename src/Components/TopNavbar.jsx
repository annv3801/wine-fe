        ...
        <header className='shadow-md bg-white font-[sans-serif]'>
            <section
                ...
                <div className="absolute sm:right-10 right-4 flex items-center">
                    <a href="tel:0966093801" className="relative sm:mr-8 mr-6 hover:text-blue-500 flex gap-5">
                    ...
                    <a href="mailto:nva030801@gmail.com" className="relative sm:mr-8 mr-6 hover:text-blue-500 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-current my-auto" viewBox="0 0 512 512">
                            <path d="M64 96c-17.7 0-32 14.3-32 32v39.9L227.6 311.3c16.9 12.4 39.9 12.4 56.8 0L480 167.9V128c0-17.7-14.3-32-32-32H64zM32 207.6V384c0 17.7 14.3 32 32 32H448c17.7 0 32-14.3 32-32V207.6L303.3 337.1c-28.2 20.6-66.5 20.6-94.6 0L32 207.6zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z"/>
                        </svg>
                    </a>
                    <a href="https://www.facebook.com/" target="_blank" className="relative sm:mr-1 hover:text-blue-500 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-current my-auto" viewBox="0 0 512 512">
            ...
            <div className='flex flex-wrap justify-center px-10 py-3 relative'>
                ...
                <ul id="collapseMenu" ref={collapseMenu} className='lg:!flex lg:space-x-10 max-lg:space-y-3 max-lg:hidden max-lg:w-full max-lg:my-4'>
                    ...
                    {/*</li>*/}
                    <li className='max-lg:border-b max-lg:py-2'><a href=''
                                                                   className='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>Tại sao bạn chọn chúng tôi</a></li>
                    <li className='max-lg:border-b max-lg:py-2'><a href=''
                                                                   className='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>Quy trình thu mua</a></li>
                    <li className='max-lg:border-b max-lg:py-2'><a href=''
                                                                   className='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>Liên hệ</a></li>
                </ul>
            </div>
        </header>
